...
@ cdecl -arch=arm ?_RegisterCallback@_CancellationTokenState@details@Concurrency@@QAAXPAV_CancellationTokenRegistration@23@@Z(ptr ptr) _CancellationTokenState_TokenRegisterCallback
@ thiscall -arch=i386 ?_RegisterCallback@_CancellationTokenState@details@Concurrency@@QAEXPAV_CancellationTokenRegistration@23@@Z(ptr ptr) _CancellationTokenState_TokenRegisterCallback
@ cdecl -arch=win64 ?_RegisterCallback@_CancellationTokenState@details@Concurrency@@QEAAXPEAV_CancellationTokenRegistration@23@@Z(ptr ptr) _CancellationTokenState_TokenRegisterCallback
